      ...
      <div class="wrapper">
          ...
          <div class="content-wrapper bg-red-50 ">
              ...
              <div class="card-body pb-16 container mx-auto">
                  <h2 class="text-center text-xl font-bold my-10">THÊM SẢN PHẨM</h2>
                  <div class="border mx-auto bg-white p-4" style=" width: 30%">
                      <form action="" class="mx-auto" method="POST" enctype="multipart/form-data">
                          ...
                          <table class="mx-auto p-10 text-lg" style="width: 50%;">
                              ...
                              <tr>
                                  <td> <input class=" border p-1 rounded-lg " width="100%" placeholder="Tên sản phẩm..." type="text"  name="tensp" id=""> </td>
                              </tr>
                              ...
                              <tr>
                                  <td>
                                      <input class=" border p-1 rounded-lg " width="500px" type="number" placeholder="Giá gốc..."  name="giagoc" id="">
                                  </td>
                              </tr>
                              <!-- 1hang -->
                              ...
                              <tr>
                                  <td>
                                      <input class=" border p-1 rounded-lg " width="30px" type="number" placeholder="Giá sale..."  name="giasale" id="">
                                  </td>
                              </tr>
                              <!-- 1hang -->
                              ...
                              <tr>
                                  <td>
                                      <textarea class="border w-56 rounded-lg p-1" style="height: 100px; width: 230px;" name="chitiet"  id="" placeholder="Chi tiết sản phẩm..." cols="30" rows="10"></textarea>
                                  </td>
                              </tr>
                              <!-- 1hang -->
                              <tr>
                                  <td> <input class="px-3 py-2 font-bold text-lg hover:bg-yellow-600 bg-yellow-400 rounded-lg" type="submit" name="btn_them" value="Thêm" id=""></td>
