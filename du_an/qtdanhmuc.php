    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper bg-red-50 ">
        ...
        <div class="card-body pb-16">
          <h1 class="my-8 text-center font-bold text-2xl">DANH MỤC SẢN PHẨM</h1>
          <table class="table table-bordered border border-black mx-auto text-lg  bg-white" style="text-align: center; width: 50%;">
            <thead>
              <tr class="bg-yellow-50">
                <td colspan="5">
                  <?php
                  include 'themdmsp.php' ?>
                </td>
              </tr>
              <tr>
                <th style="width: 5%;">STT</th>
                <th style="width: 10%">ID</th>
                <th style="width: 30%px;">Task</th>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  <td class="p-3"><?php echo $key + 1 ?> </td>
                  ...
                  <td class="border border-black p-3 flex gap-1 text-lg">
                    <div> <a href="suadm.php?masuadm=<?php echo $value['category_id'] ?>">
                        <input class="p-1 rounded-lg bg-yellow-300 font-bold " type="submit" name="suadm" value="Sửa"></a></div>
                    <div><a onclick="return confirm ('Bạn có chắc muốn xóa không?' )" href="xoadm.php?maxoadm=<?php echo $value['category_id'] ?>"> <input class="p-1 rounded-lg bg-red-100 font-bold " type="submit" name="xoadm" value="Xóa"></a>
                    </div>
                  </td>
                </tr>
